...
class Admin:
   # print ("admin reported")
    # Admin class constructor for initalizaing the object
    def __init__(self, id=None, name=None, password=None, is_admin=None):
    ...
    def login(self, name, password):
        ...
        query = "update user set logged_in='no' where logged_in='yes'"
        db = DB()
