...
class Users(QMainWindow):
    ...
    def load_users_data(self):
        query = "SELECT id, user_name, password, roles FROM admin where user_name != 'admin'"
    ...
    def add_update_users_data(self):
        query = "SELECT id, user_name, password, roles FROM user where user_name != 'admin' " \
    ...
    def search_users(self, search_obj):
        ...
        print("Search")
        if search != "":
            query = "SELECT id, user_name, password, roles FROM user " \
                    "where user_name != 'admin' and user_name like %s"
            values = ("%" + search + "%",)
        else:
            query = "SELECT id, user_name, password, roles FROM user " \
